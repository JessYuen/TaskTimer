...
//        Log.d(TAG, "onBindViewHolder: starts");
        ...
        if (mCursor == null || mCursor.getCount() == 0) {
            ...
            final Task task = new Task(mCursor.getLong(mCursor.getColumnIndexOrThrow(TasksContract.Columns._ID)),
                    mCursor.getString(mCursor.getColumnIndexOrThrow(TasksContract.Columns.TASKS_NAME)),
                    mCursor.getString(mCursor.getColumnIndexOrThrow(TasksContract.Columns.TASKS_DESCRIPTION)),
...
//        }
     ...
     * @return previously set Cursor, or null if there wasn't one
     * If the given new Cursor is the same instance as the previous
